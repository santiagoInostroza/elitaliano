<div  x-data="editPurchase(@entangle('items').defer,@entangle('items2').defer,@entangle('quantity').defer,@entangle('quantityBox').defer,@entangle('totalQuantity').defer,@entangle('price').defer,@entangle('priceBox').defer,@entangle('totalPrice').defer,@js($products),@entangle('total_sale').defer,@entangle('supplier_id').defer, @entangle('payment_status').defer, @entangle('payment_amount').defer, @entangle('comment').defer)"  id="editPurchase" class="text-gray-600"  x-init="startEditPurchase()">
        ...
        <section class="lg:col-span-2">
            ...
            <article class="shadow bg-white border rounded h-20 mb-2">
                <div class="flex justify-between gap-2 items-center p-1 border h-full">
                    ...
                    <div class="text-2xl">$<span x-text="number_format(total_sale)"></span></div>
                </div>
            </article> 
    ...
    <div class="flex items-center gap-4 p-2">
        ...
        <x-jet-button x-on:click="editPurchase()">
            Editar Compra
            <div x-show="loading">
